...
@export var next_scene: String = "res://scenes/levels/chapter_7/chapter_7_combat.tscn"
@export var chapter_name: String = "Chapter 7"
@export var show_intro_dialog: bool = true
@export var intro_dialog_path: String = "res://dialogs/chapter_7_intro.json"
