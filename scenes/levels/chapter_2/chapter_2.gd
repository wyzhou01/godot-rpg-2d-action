...
@export var chapter_name: String = "Chapter 2"
@export var show_intro_dialog: bool = true
@export var intro_dialog_path: String = "res://dialogs/chapter_2_intro.json"
...
func _ready() -> void:
	...
	# 2. 找 Boss
	_boss = find_child("Frost", true, false)
	if _boss:
...
func _on_boss_defeated() -> void:
	...
	# 弹对话
	if DialogueHelper:
		DialogueHelper.show("res://dialogs/chapter_2_boss_defeat.json")
